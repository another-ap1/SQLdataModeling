...
(
  id SERIAL PRIMARY KEY,
  passanger_id INTEGER NOT NULL REFERENCES passanger,
  seat TEXT NOT NULL,
...
INSERT INTO passanger (first_name, last_name)
VALUES
...
VALUES
  ...
  (1, '20A', '2018-04-15 16:50:00', '2018-04-15 21:00:00', 3, 'Seattle', 1, 'Mexico City', 7),
  (4, '23D', '2018-08-01 18:30:00', '2018-08-01 21:50:00', 4, 'Paris', 3, 'Casablanca', 8),
  (2, '18C', '2018-10-31 01:15:00', '2018-10-31 12:55:00', 5, 'Dubai', 4, 'Beijing', 9),
  ...
  (7, '10D', '2019-01-20 19:30:00', '2019-01-20 22:45:00', 7, 'Sao Paolo', 5, 'Santiago', 10);